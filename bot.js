...
const fs = require("fs"); 
const { Canvas, Image, registerFont } = require('canvas')
//registerFont('/.glitchassets/bein-ar-black.ttf', { family: 'BetterGames' })
  ...
  client.on('message', message => {
    if(message.author.bot) return;
           ...
           let author = message.author;
              ...
              message.channel.send('**You have 10 seconds to answer this question.**').then(msg => {

 const w = ['./w1.png'];// يولكم الخافيه
            let nothing,
...
client.login('NjQ3ODAxODIyODg2NDk0MjEw.XdllBw.eqicF0jvVKoSn8HaRzcBnr7qmc4');
